...
export default function EmptyFavouritesState({ title, description }: EmptyFavouritesStateProps) {
  ...
  const FavouritesIcon = (
    <Svg width={126} height={96} viewBox="0 0 126 96">
      ...
      <Rect x="25" y="20" width="76" height="56" rx="10" fill={THEME_COLORS.primaryForeground} />
      ...
      <Circle cx="98" cy="26" r="14" fill={THEME_COLORS.dangerRed} />
      <Path
        d="M98 31s-5-2.7-5-5.5a2.5 2.5 0 0 1 4.5-1.5 2.5 2.5 0 0 1 4.5 1.5c0 2.8-5 5.5-5 5.5z"
