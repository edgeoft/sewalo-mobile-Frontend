...
export default function EmptyBookingsState({ title, description }: EmptyBookingsStateProps) {
  ...
  return (
    <View className="rounded-2xl border border-gray-200 bg-white px-5 py-8 items-center">
      ...
      <Text className="text-sm font-sans-semibold text-gray-900 mt-2 mb-1">{displayTitle}</Text>
      <Text className="text-xs font-sans-medium text-gray-500 text-center leading-5">{displayDescription}</Text>
    </View>
  );
}
