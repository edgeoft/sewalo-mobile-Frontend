...
export default function BookingInfoCard({ booking }: BookingInfoCardProps) {
  ...
  return (
    <View className="bg-white rounded-xl border border-gray-200 p-4" style={cardShadow}>
      <Text className="text-base font-sans-bold text-gray-900 mb-3">Booking Details</Text>
      <View className="gap-1">
        {renderInfoRow('Date & Time', booking.dateTime ?? '19 Mar 2026 • 11:20AM')}
        {renderInfoRow('Location', booking.location)}
      </View>
